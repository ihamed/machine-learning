...
"""
print('Loading data......')
sub_train_images, sub_train_labels, sub_test_images, sub_test_labels = init_subset('7088') # input your ASUID last 4 digits here to generate the subset samples of MNIST for training and testing
...
tr_acc =    [0.428, 0.487, 0.711, 0.773, 0.814, 0.842, 0.860, 0.876, 0.888, 0.887]
tr_loss =   [1.383, 1.359, 0.919, 0.678, 0.563, 0.479, 0.416, 0.367, 0.330, 0.318]
test_acc =  [0.403, 0.470, 0.698, 0.785, 0.825, 0.843, 0.853, 0.853, 0.858, 0.838]
test_loss = [1.383, 1.356, 0.926, 0.681, 0.576, 0.516, 0.471, 0.437, 0.412, 0.417]
plt.plot(e, tr_acc)
plt.xlabel("Epoch Number")
plt.ylabel("Training Accuracy")
plt.title("Epoch number vs Training Accuracy")
plt.show()
...
plt.title("Epoch number vs Training Loss")
plt.show()
...
plt.title("Epoch number vs Testing Loss")
plt.show()
